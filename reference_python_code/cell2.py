...
def build_efficientnetv2_b0_full_bnless():
    ...
    se = layers.Conv2D(192, 1, activation='sigmoid', name='block4a_se_expand')(se)
    ...
    se = layers.Conv2D(384, 1, activation='sigmoid', name='block4b_se_expand')(se)
    ...
    se = layers.Conv2D(384, 1, activation='sigmoid', name='block4c_se_expand')(se)
    ...
    se = layers.Conv2D(576, 1, activation='sigmoid', name='block5a_se_expand')(se)
    ...
    se = layers.Conv2D(672, 1, activation='sigmoid', name='block5b_se_expand')(se)
    ...
    se = layers.Conv2D(672, 1, activation='sigmoid', name='block5c_se_expand')(se)
    ...
    se = layers.Conv2D(672, 1, activation='sigmoid', name='block5d_se_expand')(se)
    ...
    se = layers.Conv2D(672, 1, activation='sigmoid', name='block5e_se_expand')(se)
    ...
    se = layers.Conv2D(672, 1, activation='sigmoid', name='block6a_se_expand')(se)
    ...
    se = layers.Conv2D(1152, 1, activation='sigmoid', name='block6b_se_expand')(se)
    ...
    se = layers.Conv2D(1152, 1, activation='sigmoid', name='block6c_se_expand')(se)
    ...
    se = layers.Conv2D(1152, 1, activation='sigmoid', name='block6d_se_expand')(se)
    ...
    se = layers.Conv2D(1152, 1, activation='sigmoid', name='block6e_se_expand')(se)
    ...
    se = layers.Conv2D(1152, 1, activation='sigmoid', name='block6f_se_expand')(se)
    ...
    se = layers.Conv2D(1152, 1, activation='sigmoid', name='block6g_se_expand')(se)
    ...
    se = layers.Conv2D(1152, 1, activation='sigmoid', name='block6h_se_expand')(se)
