...
// Kích thước sau khi đệm (padding) sẽ được tính toán động trong hàm main
// để khớp với logic của script Python.
// #define PADDED_IFM_HEIGHT (IFM_HEIGHT + 2 * PADDING)
// #define PADDED_IFM_WIDTH (IFM_WIDTH + 2 * PADDING)
