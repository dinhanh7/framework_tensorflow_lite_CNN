...
int main() {
    ...
    printf("\nPerforming quantized hardsigmoid (Python logic)...\n");
    ...
    for (int i = 0; i < TENSOR_SIZE; ++i) {
        ...
        // vì là hardsigmoid nên không nhân thêm với input_hires nữa, mà chỉ nhân với 1 (tức là giữ nguyên giá trị preshift_out sau khi đã được tính toán multiplier)
        const int16_t preshift_final = reluish;
    ...
    printf("Hardsigmoid simulation finished successfully!\n");
