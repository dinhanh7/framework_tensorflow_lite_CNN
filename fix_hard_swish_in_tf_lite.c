...
int main() {
    ...
    const char* input_file = "c:\\Code c\\Tensorflow\\framework_tensorflow_lite_CNN\\all_layer_io\\layer_10_HARD_SWISH\\ifm10.txt";
    const char* output_file = "c:\\Code c\\Tensorflow\\framework_tensorflow_lite_CNN\\all_layer_io\\layer_10_HARD_SWISH\\ofm10_c_sim.txt";
    const char* params_path = "c:\\Code c\\Tensorflow\\framework_tensorflow_lite_CNN\\extracted_params\\layer010_HARD_SWISH_1_block2a_expand_activation_1_truediv__1_block2a_expand_activation_1_Relu6_1_block2a_expand_activation_1_add_1_block2a_expand_activation_1_mul\\";
    ...
    for (int i = 0; i < TENSOR_SIZE; ++i) {
        ...
        // 7.No Add Output ZP and Clip because ofm is ofm - zp, so it is the ifm - zp for the next layer.
